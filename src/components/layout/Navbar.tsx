...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    // Si tu as une fonction logout() personnalisée, garde-la si nécessaire
    logout(); // optionnel, à supprimer si elle est vide
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-hosting-navy">
                HostPro
              </span>
            </Link>
            <div className="hidden sm:ml-6 sm:flex sm:space-x-6">
              <Link
                to="/"
                className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-hosting-blue"
              >
                Home
              </Link>
            </div>
