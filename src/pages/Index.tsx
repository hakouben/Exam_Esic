...
//                 Whether you need shared hosting for your personal blog or a
//                 powerful VPS for your business, we've got you covered with
//                 rock-solid infrastructure and 24/7 support.
//               </p>
...
//                 <TabsTrigger
//                   value="MUTUALIZED"
//                   onClick={() => setSelectedType("MUTUALIZED")}
//                 >
//                   Shared Hosting
//                 </TabsTrigger>
//                 <TabsTrigger value="VPS" onClick={() => setSelectedType("VPS")}>
//                   VPS
//                 </TabsTrigger>
//               </TabsList>
//             </div>
...
//             <p className="text-xl text-gray-600 max-w-3xl mx-auto">
//               We provide top-notch hosting solutions with unmatched reliability
//               and performance.
//             </p>
//           </div>
...
//                 State-of-the-art infrastructure with SSD storage for
...
//               <p className="text-gray-600">
//                 Free SSL certificates, DDoS protection, and regular security
...
//               <p className="text-gray-600">
//                 Our redundant network ensures your website remains available to
...
//               <p className="text-gray-600">
//                 Easily upgrade your plan as your needs grow, without any
//                 downtime or technical hassle.
//               </p>
//             </div>
...
//               <p className="text-gray-600">
//                 Regular automated backups keep your data safe and allow for
...
//               <p className="text-gray-600">
//                 Real-time server stats and resource monitoring to keep your
...
//               Choose your perfect hosting plan today and take your online
...
//                   size="lg"
//                   variant="outline"
//                   className="border-white text-black hover:bg-white hover:text-hosting-navy"
//                 >
//                   Create Account
//                 </Button>
//               </Link>
...
import { Database, Server, Shield, Clock, BarChart, Cpu } from "lucide-react";
import { Link } from "react-router-dom";
import { ServiceOffer } from "@/lib/types"; // <- interface adaptée à l’API
...
const Index = () => {
  ...
  const filteredPlans =
    selectedType === "all"
      ? offers
      : offers.filter((plan) => plan.type.toUpperCase().includes(selectedType));
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section id="featured-plans" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {["all", "MUTUALIZED", "VPS"].map((tab) => (
              <TabsContent key={tab} value={tab} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {(tab === "all"
                    ? offers
                    : offers.filter((o) => o.type.toUpperCase().includes(tab))
                  ).map((plan) => (
                    <PlanCard key={plan.id} plan={plan} />
                  ))}
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <Server className="h-6 w-6 text-hosting-blue" />,
                title: "High-Performance Servers",
                text: "State-of-the-art infrastructure with SSD storage for lightning-fast website loading speeds.",
              },
              {
                icon: <Shield className="h-6 w-6 text-hosting-blue" />,
                title: "Advanced Security",
                text: "Free SSL certificates, DDoS protection, and regular security updates to keep your data safe.",
              },
              {
                icon: <Clock className="h-6 w-6 text-hosting-blue" />,
                title: "99.9% Uptime Guarantee",
                text: "Our redundant network ensures your website remains available to visitors around the clock.",
              },
              {
                icon: <Cpu className="h-6 w-6 text-hosting-blue" />,
                title: "Scalable Resources",
                text: "Easily upgrade your plan as your needs grow, without any downtime or technical hassle.",
              },
              {
                icon: <Database className="h-6 w-6 text-hosting-blue" />,
                title: "Automated Backups",
                text: "Regular automated backups keep your data safe and allow for quick recovery when needed.",
              },
              {
                icon: <BarChart className="h-6 w-6 text-hosting-blue" />,
                title: "Performance Monitoring",
                text: "Real-time server stats and resource monitoring to keep your applications running smoothly.",
              },
      ...
      <section className="py-16 bg-hosting-navy text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Get Started?</h2>
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Choose your perfect hosting plan today and take your online presence
            to the next level.
          </p>
          <div className="flex justify-center gap-4">
            <Button
